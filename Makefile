...
FINALPACKAGE = 1
CODESIGN_IPA = 0
PACKAGE_VERSION = 19.30.2-4.0.1

TWEAK_NAME = YTLitePlus
DISPLAY_NAME = PenguinTube
...
SUBPROJECTS += Tweaks/Alderis Tweaks/iSponsorBlock Tweaks/YTUHD Tweaks/YouPiP Tweaks/Return-YouTube-Dislikes Tweaks/YTABConfig Tweaks/YouMute Tweaks/DontEatMyContent Tweaks/YTHoldForSpeed Tweaks/YTVideoOverlay Tweaks/YouQuality Tweaks/YouGroupSettings Tweaks/YouTimeStamp 
...
before-package::
	...
	@for bundle in YTUHD YouPiP YouMute DontEatMyContent YTHoldForSpeed iSponsorBlock YTVideoOverlay YouQuality YouTimeStamp; do \
		cp -R Tweaks/$$bundle/layout/Library/Application\ Support/$$bundle.bundle Resources/; \
	done
